...
-- Sets the folding mode to indent "For Python"
...
-- Open a new buffer with <Space>b
vim.keymap.set("n", "<leader>b", ":enew<CR>", { noremap = true, silent = true, desc = "Open new buffer" })
...
-- Run selected lines of code with <leader>r in visual mode
